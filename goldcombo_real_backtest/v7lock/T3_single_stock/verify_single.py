...
"""T3 single stock verification: 600438 通威股份"""
import sys
...
df = pd.read_csv('/Users/junze/quant-monitor-local/data/ashare_kline/600438.csv')
df['date'] = pd.to_datetime(df['date'])
df = df.set_index('date')
df = df[(df.index >= '2022-01-01') & (df.index <= '2026-08-14')]

print('600438 通威股份 数据:')
